...
A person can have any number of dietTags (including 0)
</div>
...
* When editing dietTags, the existing dietTags of the person will be removed i.e adding of dietTags is not cumulative.
* You can remove all the person’s dietTags by typing `t/` without
    specifying any dietTags after it.

Examples:
*  `edit 1 p/91234567 e/johndoe@example.com` Edits the phone number and email address of the 1st person to be `91234567` and `johndoe@example.com` respectively.
*  `edit 2 n/Betsy Crower t/` Edits the name of the 2nd person to be `Betsy Crower` and clears all existing dietTags.
