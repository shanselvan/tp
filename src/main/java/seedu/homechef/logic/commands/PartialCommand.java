...
public class PartialCommand extends Command {
    ...
    public static final String MESSAGE_ALREADY_PARTIAL =
            "Order is already marked as partially paid. "
            + "Use 'paid INDEX' or 'unpaid INDEX' to change the payment status.";
